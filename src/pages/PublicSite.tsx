  ...
  return (
    <main className="site-shell">
      ...
      <header className="topbar">
        ...
        <MoneyMindButton variant="black" size="sm" icon={<Phone size={14} />} onClick={() => trackEvent('call_click')}>
          <a href={phoneHref} aria-label="Call BIZ Premium Outlet">Call the store</a>
        </MoneyMindButton>
      ...
      <section className="visit-section" id="visit"><div className="visit-image"><img src="/images/image copy 3.png" alt="BIZ Premium Outlet storefront" onError={handleImageError} /></div><div className="visit-panel"><div className="section-label">04 / Find your way here</div><h2>Make it a<br /><em>good visit.</em></h2><p>Drop by for a browse, stay for the details. Our team is here to help you find something that feels entirely yours.</p><div className="visit-details"><div><MapPin size={18} /><span><strong>6/1A1, Doddagubbi Main Rd</strong>Opp. SAM PALACE, CROSS, Kothanur<br />Bengaluru, Karnataka 560077</span></div><div><Clock3 size={18} /><span><strong>Open today</strong>Every day · 10:00 AM — 10:30 PM</span></div><div><Phone size={18} /><span><strong>{phoneNumber}</strong>Call us for a quick question</span></div></div><div className="visit-actions"><MoneyMindButton variant="black" size="lg" icon={<Compass size={16} />} onClick={() => trackAnd('directions_click', () => window.open('https://www.google.com/maps/search/?api=1&query=BIZ+Premium+Outlet+Kothanur+Bengaluru', '_blank', 'noopener,noreferrer'))}>Get directions</MoneyMindButton><MoneyMindButton variant="white" size="lg" onClick={() => trackEvent('call_click')}><a href={phoneHref} aria-label="Call BIZ Premium Outlet">Call the store</a></MoneyMindButton></div></div></section>

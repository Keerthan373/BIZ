...
const phoneNumber = '+91 98453 05785';
const phoneHref = 'tel:+919845305785';
  ...
  return (
    <main className="site-shell">
      ...
      <section className="hero" id="top">
        ...
        <div className="hero-image-wrap"><img src={heroImageUrl} alt="Warmly lit interior of BIZ Premium Outlet" className="hero-image" onError={handleImageError} /></div>
      ...
      <section className="visit-section" id="visit"><div className="visit-image"><img src="/images/image copy 3.png" alt="BIZ Premium Outlet storefront" onError={handleImageError} /></div><div className="visit-panel"><div className="section-label">04 / Find your way here</div><h2>Make it a<br /><em>good visit.</em></h2><p>Drop by for a browse, stay for the details. Our team is here to help you find something that feels entirely yours.</p><div className="visit-details"><div><MapPin size={18} /><span><strong>6/1A1, Doddagubbi Main Rd</strong>Opp. SAM PALACE, CROSS, Kothanur<br />Bengaluru, Karnataka 560077</span></div><div><Clock3 size={18} /><span><strong>Open today</strong>Every day · 10:00 AM — 10:30 PM</span></div><div><Phone size={18} /><span><strong>{phoneNumber}</strong>Call us for a quick question</span></div></div><div className="visit-actions"><MoneyMindButton variant="black" size="lg" icon={<Compass size={16} />} onClick={() => trackAnd('directions_click', () => window.open('https://www.google.com/maps/search/?api=1&query=BIZ+Premium+Outlet+Kothanur+Bengaluru', '_blank', 'noopener,noreferrer'))}>Get directions</MoneyMindButton><MoneyMindButton variant="white" size="lg" onClick={() => trackAnd('call_click', () => { window.location.href = phoneHref; })}>Call the store</MoneyMindButton></div></div></section>
      ...
      <footer className="footer"><div className="footer-brand"><span className="brand-mark">BIZ</span><span>Premium Outlet</span></div><p>For the way you live. For the way you look.</p><div className="footer-links"><button onClick={() => scrollTo('top')}>Back to top ↑</button><a href={`https://wa.me/${whatsappNumber}`} target="_blank" rel="noreferrer" onClick={() => trackEvent('whatsapp_click')}><MessageCircle size={16} /> WhatsApp</a></div><div className="footer-bottom"><span>© 2024 BIZ Premium Outlet</span><span>Kothanur, Bengaluru</span></div></footer>
    </main>
  );
}
